...
class ConfirmApp extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    return new MaterialApp(
      ...
      home: new ConfirmPage(title: '홍길동 형제 - 오전'),
    );
  }
}
...
class _ConfirmState extends State<ConfirmPage> {
  ...
  Future<void> confirmA(String message, int process) async {
    return showDialog<void>(
      context: context,
      barrierDismissible: false, // user must tap button!
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          actions: <Widget>[
            ...
            FlatButton(
              ...
              onPressed: () {
                setState(() {
                  departCells.add(arriveCells.removeAt(process));
                });
                Navigator.of(context).pop();
              },
            ),
